...
# Allow all origins — required for HuggingFace + Vercel/Netlify frontend
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
@app.get("/")
def health():
    return {"status": "DocAI backend is running"}

# Explicit OPTIONS handler — fixes CORS preflight on HuggingFace
